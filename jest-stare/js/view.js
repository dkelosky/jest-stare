...
function generateChartsFromTagIdPrefix(tagPrefix) {
    ...
    const baseTen = 10;
    const passed = parseInt(resultsParsed[passedIndex], baseTen);
    const total = parseInt(resultsParsed[totalIndex], baseTen);
...
function buildCanvas(canvas, config) {
    const doughnut = new chart_js_1.Chart(canvas, config);
}
},{"chart.js":3,"jquery":59}],2:[function(require,module,exports){
//! moment.js
//! version : 2.18.1
...
},{"../core/core.defaults":21,"../helpers/index":41,"moment":2}],54:[function(require,module,exports){
/* MIT license */
